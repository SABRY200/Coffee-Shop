...
<?php
	...
	$products->execute();
	$all_products = $products->fetchAll(PDO::FETCH_OBJ);
	//Reviews
	$reviews = $connect->query("SELECT * FROM reviews");
	$reviews->execute();
				...
				<div class="testimony">
					...
					<div class="author d-flex mt-4">
						<div class="image mr-3 align-self-center">
							<img src="<?php echo APPURL; ?>/images/person_1.jpg" alt="">
						</div>
						<div class="name align-self-center"><?php echo $review->username; ?> <span class="position">Back-End Developer</span></div>
					</div>
				</div>
			</div>
		<?php endforeach; ?>
